...
if __name__ == '__main__':
    ...
    version = f'numcones_{num_cones}_trainsize_{train_size}_fold_{kfold_index}'
    selected_kappa_betas = [[-1.0, 4.0], [1.0, 0.25], [2.0, 4.0]]
    selected_graphs = [[0, 6], [49], [0, 454]]
    ...
    experiment_dir = './src/cross_validation/iso_efp_unsafe'
